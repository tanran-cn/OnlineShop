...
from .serializers import GoodsSerializer, CategorySerializer, HotWordsSerializer, BannerSerialezer
...
class BannerViewset(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    serializer_class = BannerSerialezer
...
class IndexCategoryViewset(CacheResponseMixin, mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    首页商品分类数据
    """
    queryset = GoodsCategory.objects.filter(is_tap=True, name__in=["生鲜食品","酒水饮料"])
