...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self", null=True, blank=True, verbose_name="父类目级", help_text="父类目",
                                        related_name="sub_cat")
    is_tap = models.BooleanField(default=False, verbose_name="是否导航", help_text="是否导航")
...
class Goods(models.Model):
    ...
    name = models.CharField(max_length=105, verbose_name="商品名")
